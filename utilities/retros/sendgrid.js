...
async function markdown () {
  const organization = 'sendgrid' // change this if you want to use a different organization
  ...
  fs.writeFile(path.resolve(`./reports/retros/sendgrid-${dates.start}.md`), retro)
}
